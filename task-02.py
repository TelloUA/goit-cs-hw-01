...
class Parser:
    ...
    def factor(self):
        """
        Або віддаємо число, або відкриваємо дужки, і працюємо з дужками
        """
        token = self.current_token
    ...
    def term(self):
        """
        Проганяємо усі операції з множенням, діленням, раніше ніж додавання/віднімання
        """
        node = self.factor()
    ...
    def expr(self):
        """
        Тут вже ми отримали чи число, чи дужки, чи множення/ділення і залишились останні операції
        """
        node = self.term()
